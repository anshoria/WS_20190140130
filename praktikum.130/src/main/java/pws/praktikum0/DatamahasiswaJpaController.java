...
import pws.praktikum0.exceptions.NonexistentEntityException;
import pws.praktikum0.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("pws_praktikum.130_jar_0.0.1-SNAPSHOTPU");
